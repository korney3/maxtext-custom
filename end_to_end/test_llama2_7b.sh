...
export MY_BUCKET_NAME=llama-jax-korney3
export BASE_OUTPUT_DIRECTORY=gs://${MY_BUCKET_NAME}
# Non-Googlers please remember to point `DATASET_PATH` to the GCS bucket where you have your training data
export DATASET_PATH=gs://${MY_BUCKET_NAME}
...
export META_CHECKPOINT_PATH=gs://${MY_BUCKET_NAME}/llama-2-7b
